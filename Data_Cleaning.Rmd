...
```{r}
#One of the datasets was a sqlite file so I needed to load that into R using the RSQLite package
library("RSQLite")
...
#Save the results dataset (the second dataset)
write.csv(lDataFrames[[2]], "./match_results.csv")
